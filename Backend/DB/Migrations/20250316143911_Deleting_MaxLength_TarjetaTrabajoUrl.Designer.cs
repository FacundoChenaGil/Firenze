...
namespace DB.Migrations
{
    ...
    [Migration("20250316143911_Deleting_MaxLength_TarjetaTrabajoUrl")]
    partial class Deleting_MaxLength_TarjetaTrabajoUrl
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DB.Estado_Turno", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id_Estado_Turno_Et = 1,
                            Descripcion_Et = "Ausente"
                        },
                        new
                        {
                            Id_Estado_Turno_Et = 2,
                            Descripcion_Et = "Cancelado"
                        },
                        new
                        {
                            Id_Estado_Turno_Et = 3,
                            Descripcion_Et = "Pendiente de Pago"
                        },
                        new
                        {
                            Id_Estado_Turno_Et = 4,
                            Descripcion_Et = "Solicitado"
                        },
                        new
                        {
                            Id_Estado_Turno_Et = 5,
                            Descripcion_Et = "Finalizado"
                        });
                });
            ...
            modelBuilder.Entity("DB.Tipo_Trabajo", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id_Tipo_Trabajo_Ttr = 1,
                            Descripcion_Ttr = "Pedicuría"
                        },
                        new
                        {
